...
from CRUSHMUSIC.misc import _boot_
from CRUSHMUSIC.plugins.sudo.sudoers import sudoers_list
...
from CRUSHMUSIC.utils.decorators.language import LanguageStart
from CRUSHMUSIC.utils.formatters import get_readable_time
from CRUSHMUSIC.utils.inline.start import private_panel, start_panel
from CRUSHMUSIC.utils.inline.help import first_page
...
async def start_pm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name.startswith("help"):
            ...
            result = (await results.next())["result"][0]  # Get first result
