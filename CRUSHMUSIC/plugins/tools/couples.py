...
from  CRUSHMUSIC import app as app
from  CRUSHMUSIC.mongo.couples_db import _get_image, get_couple
...
async def ctest(_, message):
    ...
    try:
         ...
         try:
            ...
            p1 = " CRUSHMUSIC/assets/upic.png"
         try:
            p2 = await app.download_media(photo2.big_file_id, file_name="pfp1.png")
         except Exception:
            p2 = " CRUSHMUSIC/assets/upic.png"
            
         img1 = Image.open(f"{p1}")
         img2 = Image.open(f"{p2}")

         img = Image.open(" CRUSHMUSIC/assets/crush/ CRUSHCP.png")
