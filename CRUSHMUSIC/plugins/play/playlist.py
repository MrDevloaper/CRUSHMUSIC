...
from  CRUSHMUSIC.utils import close_markup
from config import BANNED_USERS, SERVER_PLAYLIST_LIMIT
from  CRUSHMUSIC import Carbon, app
from  CRUSHMUSIC.utils.decorators.language import language, languageCB
from  CRUSHMUSIC.utils.inline.playlist import (botplaylist_markup,
                                              get_playlist_markup,
                                              warning_markup)
...
from  CRUSHMUSIC.core.mongo import mongodb
...
async def add_playlist(client, message: Message, _):
    ...
    if "https://youtu.be" in query:
        ...
        from  CRUSHMUSIC import YouTube
...
@app.on_callback_query(filters.regex("prashants_playlist") & ~BANNED_USERS)
@languageCB
async def add_playlist(client, CallbackQuery, _):
    callback_data = CallbackQuery.data.strip()
    videoid = callback_data.split(None, 1)[1]
