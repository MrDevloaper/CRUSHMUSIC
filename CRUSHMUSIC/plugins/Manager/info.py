...
crushphoto = [
    "https://envs.sh/VBn.jpg",
    "https://envs.sh/6BH.jpg",
    "https://envs.sh/VBn.jpg",
    "https://envs.sh/6BH.jpg"
]


bg_path = " CRUSHMUSIC/assets/crush/CrushNinfo.png"
font_path = " CRUSHMUSIC/assets/crush/prashantsinf.ttf"
...
async def userinfo(client: Client, message: Message):
    ...
    try:
        ...
        if target_user.photo:
            ...
            welcome_photo = random.choice(crushphoto)
            await app.send_photo(
                chat_id,
                photo=welcome_photo,
                caption=INFO_TEXT.format(
