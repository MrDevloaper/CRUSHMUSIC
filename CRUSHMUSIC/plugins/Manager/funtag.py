...
GM_MESSAGES = [ "**➠ ɢᴏᴏᴅ ᴍᴏʀɴɪɴɢ, ᴋᴇsᴇ ʜᴏ 🐱**",
         ...
         "**➠ ᴜᴛʜ ᴊᴀ ʙᴀʙʏ, ᴠᴀʀɴᴀ ᴀʙ ᴄʜᴀɴᴛᴇ ᴘᴀᴅᴇɴɢᴇ! 🙃**",
         "**➠ ɢᴍ ᴊᴀᴀɴ, ᴛᴜᴍʜᴀʀɪ ʏᴀᴀᴅ ᴀᴀ ʀʜɪ ᴛʜɪ, ᴘʜɪʀ sᴏ ɢʏᴀ ʙᴜᴛ ᴄʜᴀʟᴏ ᴀʙ ᴜᴛʜᴏ 😴❤️**",
         "**➠ ᴄʜʜᴀɪ ɴᴀʜɪ ᴘɪʏᴏɢᴇ ᴛᴏ ᴏғғɪᴄᴇ ᴍᴇ ɴɪᴅ ᴀᴀ ᴊᴀʏᴇɢɪ, ᴛᴏ ʟᴏ ᴄʜᴀɪ ☕😌**",
        "**➠ ᴍᴏʀɴɪɴɢ ᴍᴇ ᴊᴏ ᴜᴛʜ ɢᴀʏᴀ, ᴡᴏ ᴅᴜɴɪʏᴀ ᴊɪᴛ ʟᴇᴛᴀ ʜᴀɪ, ᴛᴜᴍʜᴇɪ ᴋʏᴀ ᴋᴀʀɴᴀ ʜᴀɪ? 😏**",
         "**➠ ʙᴀʙʏ, ᴀᴋʜᴏɴ ᴍᴇ ᴘʏᴀʀ ʟᴇᴋɪɴ ᴘᴀʟᴀɴɢ ᴘᴇ ᴀʟsɪ, ᴇsᴇ ᴋᴀɪsᴇ ᴄʜᴀʟᴇɢᴀ? 🥱😆**",
         "**➠ ɢᴏᴏᴅ ᴍᴏʀɴɪɴɢ, ᴛᴜᴍʜᴀʀɪ ɴɪᴅ ᴛᴏ ᴍᴇʀᴀ ᴅᴜsᴍᴀɴ ʟᴀɢ ʀʜᴀ ʜᴀɪ! 😤😂**",
         "**➠ ʜᴇʟʟᴏ ᴊᴀᴀɴ, ʏᴇ ʜᴀʟᴀᴛ ʜᴀɪ ᴛᴜᴍʜᴀʀᴀ? ᴀʙʜɪ ᴛᴀᴋ ʙᴇᴅ ᴘᴇ? 😵‍💫**",
         "**➠ ɢᴏᴏᴅ ᴍᴏʀɴɪɴɢ, ᴛᴜᴍʜᴀʀɪ ɴɪᴅ ʜɪ ᴋʜᴀᴛᴀᴍ ɴᴀʜɪ ʜᴏᴛɪ, ʏᴀʀ! 😴😂**",
         "**➠ ᴜᴛʜ ᴊᴀ, ʙʀᴇᴀᴋғᴀsᴛ ᴋᴀʀʟᴇ, ᴡᴀʀɴᴀ ᴍᴀᴍᴍɪ ᴛᴀɴᴛʀɪᴋ ʙᴀɴ ᴊᴀʏᴇɴɢɪ 😆🍽️**",
         "**➠ ɢᴍ ʙᴀʙʏ, ᴊᴀʟᴅɪ ᴜᴛʜᴏ ᴠᴀʀɴᴀ ᴛᴜᴍʜᴀʀɪ ᴘʜᴏᴛᴏ ᴅᴀʟ ᴅᴜɴɢɪ "ᴍɪssɪɴɢ ᴘᴇʀsᴏɴ" ᴘᴇ 😂📢**",
        ]
...
GN_MESSAGES = [ " **➠ ɢᴏᴏᴅ ɴɪɢʜᴛ 🌚** ",
           ...
           " **➠ ᴏᴋ ᴅᴏɴᴇ ғᴏʀ ᴛʜᴇ ᴅᴀʏ, ᴀʙ ᴛᴏ sᴏ ᴊᴀᴏ ᴍᴇʀᴇ ʀᴀᴊᴀ / ʀᴀɴɪ 😴✨** ",
           " **➠ ʏᴀᴀʀ ɪᴛɴᴀ ᴅᴇʀ ʜᴏ ɢʏᴀ, ᴄʜᴀɴᴅ ʙʜɪ ʙᴏʟ ʀʜᴀ ʜᴀɪ 'sᴏ ᴊᴀᴏ ʙʜᴀɪ' 😆🌙** ",
           " **➠ ɢɴ ᴊᴀᴀɴ, ʙs ᴋʜᴡᴀʙᴏɴ ᴍᴇ ʏᴀᴀᴅ ʀᴀᴋʜɴᴀ 😍🌌** ",
           " **➠ ᴊᴏ ᴘʏᴀʀ ᴍᴇ ᴅʜᴏᴋʜᴀ ᴅᴇᴛᴇ ʜᴀɪ, ᴜɴʜᴇɪ ᴋʜᴡᴀʙ ᴍᴇ ʙʜɪ ɴɪᴅ ɴʜɪ ᴀᴛɪ! 😂😜** ",
           " **➠ ʜᴀʟᴋɪ ᴄʜʜᴜᴛ ᴛᴜᴍʜᴀʀɪ, ᴅᴜʀ ᴛᴀᴋ ᴄʜᴀʟɪ ɢᴀʏɪ, ɢɴ ᴊᴀᴀɴ, ᴍᴇʀɪ ʏᴀᴅ ᴀᴀʏɪ 😏❤️** ",
           " **➠ ᴋʜᴡᴀʙ ᴛᴜᴍʜᴀʀᴇ ᴘʏᴀʀ ᴋᴀ, ᴍᴜᴊʜᴇ ʜᴀʀ ʀᴀᴀᴛ ᴀᴀᴛᴀ ʜᴀɪ, ᴛᴜᴍʜᴇɪ ʙʜɪ ᴀᴀᴇ ᴛᴏ ᴢᴜʀᴜʀ ʙᴀᴛᴀɴᴀ 😘✨** ",
           " **➠ ɢɴ ᴅᴜsᴛᴏ, ᴊᴏ sᴏ ɢʏᴇ ᴡᴏ ᴋʜᴡᴀʙ ᴍᴇ ᴍɪʟᴛᴇ ʜᴀɪ, ᴊᴏ ɴʜɪ sᴏʏᴇ ᴡᴏ ᴡʜᴀᴛsᴀᴘᴘ ᴘᴇ ᴍɪʟᴛᴇ ʜᴀɪ! 😂📱** ",
           " **➠ ᴛᴜᴍʜᴀʀᴀ ʙᴇᴅ ᴘᴀʀ ʙʜᴜᴛ ʙᴜʀᴀ ʜᴀʟ ʜᴏ ʀʜᴀ ʜᴀɪ, ᴛᴜᴍʜᴇɪ ʟᴀʏɴᴇ ᴋᴇ ʟɪʏᴇ ʙᴏʟ ʀʜᴀ ʜᴀɪ 😴🛏️** ",
           " **➠ ᴍᴀɴᴏ ʏᴀ ɴᴀ ᴍᴀɴᴏ, ᴘʏᴀʀ ᴍᴇ ʜᴜᴍ ᴅᴏɴᴏ ʙᴀʀᴀʙᴀʀ ʜᴀɪ, ᴘᴀʀ ɴɪᴅ ʙᴀs ᴍᴜᴊʜᴇɪ ʜɪ ɴʜɪ ᴀᴛɪ! 😜😂** ",
            ]
...
TAG_ALL = [
           ...
           " **𝐇𝐞𝐥𝐥𝐨 𝐉𝐢 𝐍𝐚𝐦𝐚𝐬𝐭𝐞😛** ",
           " **𝐇𝐞𝐥𝐥𝐨 𝐁𝐚𝐛𝐲 𝐊𝐤𝐫𝐡..?🤔** ",
           " **𝐃𝐨 𝐘𝐨𝐮 𝐊𝐧𝐨𝐰 𝐖𝐡𝐨 𝐈𝐬 𝐌𝐲 𝐎𝐰𝐧𝐞𝐫 [@inkholicheart].?** ",
...
async def cancel_mention(client, message):
    ...
    spam_chats.remove(chat_id)
    await message.reply("๏ 🦋ℓσѕт_ιη_тυηє  𝐓𝐀𝐆 𝐏𝐑𝐎𝐒𝐄𝐒𝐒 𝐒𝐓𝐎𝐏.....🫠 ๏")
