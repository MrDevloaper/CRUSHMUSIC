...
from  CRUSHMUSIC.mongo.nightmodedb import nightdb,nightmode_on,nightmode_off,get_nightchats 
...
async def _nightmode(_, message):
    return await message.reply_photo(photo="https://envs.sh/6H_.jpg", caption="**ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ ᴛᴏ ᴇɴᴀʙʟᴇ ᴏʀ ᴅɪsᴀʙʟᴇ ɴɪɢʜᴛᴍᴏᴅᴇ ɪɴ ᴛʜɪs ᴄʜᴀᴛ.**",reply_markup=buttons)
