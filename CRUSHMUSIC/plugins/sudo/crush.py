import requests
import random
from  CRUSHMUSIC import app, userbot
...
async def restriction_app(app :app, message):
    ...
    if len(message.text) < 2:
        return await message.reply(random.choice(Prashant_text))
        ...
        for banned in data:
            ...
            if banned in ban:
                if user_id in SUDOERS:
                    ...
                    await message.reply("OK, Ban kar diya pagal ko sala ganda tha !")
        ...
        for kicked in data:
            ...
            if kicked in kick:
                if user_id in SUDOERS:
                    ...
                    await app.ban_chat_member(chat_id, user_id)
                    await app.unban_chat_member(chat_id, user_id)
                    await message.reply("get lost! bhga diya darphok ko") 
