...
from  CRUSHMUSIC.utils.formatters import time_to_seconds
    ...
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="⛦ ᴏᴡɴᴇʀ ❥", url=f"https://t.me/Forever_Crush"
            ),
            InlineKeyboardButton(
                text="⛦ sᴜᴘᴘᴏʀᴛ ❥", url=f"https://t.me/Crush_Forever_Support"
            ),
         ],
...
def playlist_markup(_, videoid, user_id, ptype, channel, fplay):
    buttons = [
        [
            InlineKeyboardButton(text=_["P_B_1"], callback_data=f"PRASHANTPlaylists {videoid}|{user_id}|{ptype}|a|{channel}|{fplay}"),
            InlineKeyboardButton(text=_["P_B_2"], callback_data=f"PRASHANTPlaylists {videoid}|{user_id}|{ptype}|v|{channel}|{fplay}"),
        ],
        [
