...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype(" CRUSHMUSIC/assets/thumb/font2.ttf", 30)
    font = ImageFont.truetype(" CRUSHMUSIC/assets/thumb/font.ttf", 30)
    title_font = ImageFont.truetype(" CRUSHMUSIC/assets/thumb/font3.ttf", 45)
    ...
    play_icons = Image.open(" CRUSHMUSIC/assets/thumb/play_icons.png")
